(() => {
  ...
  class $bf7fb46c6d68ead7$var$$e8379818650e2442$export$93654d4f2d6cd524 {
    ...
    toArrayBuffer() {
      ...
      return $bf7fb46c6d68ead7$var$$e8379818650e2442$var$concatArrayBuffers(
        buffer
      ).buffer;
    }
    constructor() {
  ...
  function $bf7fb46c6d68ead7$var$$e8379818650e2442$var$concatArrayBuffers(
    bufs
  ) {
    let size = 0;
    for (const buf of bufs) size += buf.byteLength;
  ...
  function $bf7fb46c6d68ead7$export$417857010dc9287f(data) {
    const unpacker = new $bf7fb46c6d68ead7$var$$0cfd7828ad59115f$var$Unpacker(
      data
    );
  ...
  class $bf7fb46c6d68ead7$export$b9ec4b114aa40074 {
    ...
    constructor() {
      this._bufferBuilder =
        new $bf7fb46c6d68ead7$var$$e8379818650e2442$export$93654d4f2d6cd524();
  ...
  function $9fea4db837311579$export$1f48841962b828b1(
    window1,
    eventNameToWrap,
    wrapper
  ) {
  ...
  function $9fea4db837311579$export$2d31490a0c05f094(window1) {
    ...
    if (
      typeof window1 === "undefined" ||
      !window1.navigator ||
      !window1.navigator.userAgent
    ) {
    ...
    if (navigator.mozGetUserMedia) {
      ...
      result.version = $9fea4db837311579$export$e3c02be309be1f23(
        navigator.userAgent,
        /Firefox\/(\d+)\./,
        1
      );
      ...
      (window1.isSecureContext === false && window1.webkitRTCPeerConnection)
    ) {
      ...
      result.supportsUnifiedPlan =
        window1.RTCRtpTransceiver &&
        "currentDirection" in window1.RTCRtpTransceiver.prototype;
    } else {
  ...
  function $9fea4db837311579$export$15384eac40dc88c8(data) {
    ...
    return Object.keys(data).reduce(function (accumulator, key) {
      ...
      const value = isObj
        ? $9fea4db837311579$export$15384eac40dc88c8(data[key])
        : data[key];
  ...
  function $9fea4db837311579$export$571b373e75babb58(stats, base, resultSet) {
    ...
    Object.keys(base).forEach((name) => {
      if (name.endsWith("Id"))
        $9fea4db837311579$export$571b373e75babb58(
          stats,
          stats.get(base[name]),
          resultSet
        );
  ...
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "shimMediaStream",
    () => $fb04e59b477f17ce$export$33ee24e7a300bcd1
  );
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "shimOnTrack",
    () => $fb04e59b477f17ce$export$f358708f68ab068
  );
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "shimGetSendersWithDtmf",
    () => $fb04e59b477f17ce$export$a41a030a2842f5d6
  );
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "shimSenderReceiverGetStats",
    () => $fb04e59b477f17ce$export$f2f0f2338114eb4b
  );
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "shimAddTrackRemoveTrackWithNative",
    () => $fb04e59b477f17ce$export$30e3cdd46f8d5100
  );
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "shimAddTrackRemoveTrack",
    () => $fb04e59b477f17ce$export$9588259fcf4ebc91
  );
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "shimPeerConnection",
    () => $fb04e59b477f17ce$export$852a08dda9a55ea7
  );
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "fixNegotiationNeeded",
    () => $fb04e59b477f17ce$export$341293bbeaae37cb
  );
  $parcel$export(
    $fb04e59b477f17ce$exports,
    "shimGetUserMedia",
    () => $de41d89a4eaa283f$export$1ed4910f4d37dc5e
  );
  /*
   *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
   *
   ...
   */ /* eslint-env node */
  ("use strict");
  const $de41d89a4eaa283f$var$logging =
    $9fea4db837311579$export$bef1f36f5486a6a3;
    ...
    if (!("getStats" in window.RTCRtpSender.prototype)) {
      ...
      window.RTCRtpSender.prototype.getStats = function getStats() {
        ...
        return this._pc.getStats().then((result) =>
           ...
           */ $9fea4db837311579$export$93439ffc3f787d51(
            result,
            sender.track,
            true
          )
  ...
  function $fb04e59b477f17ce$export$9588259fcf4ebc91(window, browserDetails) {
    ...
    if (
      ...
      return $fb04e59b477f17ce$export$30e3cdd46f8d5100(window);
  ...
  function $fb04e59b477f17ce$export$341293bbeaae37cb(window, browserDetails) {
    $9fea4db837311579$export$1f48841962b828b1(
      window,
      "negotiationneeded",
      (e) => {
        const pc = e.target;
  ...
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimOnTrack",
    () => $215e6581d7a09c61$export$f358708f68ab068
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimPeerConnection",
    () => $215e6581d7a09c61$export$852a08dda9a55ea7
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimSenderGetStats",
    () => $215e6581d7a09c61$export$f0525502095c04ef
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimReceiverGetStats",
    () => $215e6581d7a09c61$export$83d69126527b1171
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimRemoveStream",
    () => $215e6581d7a09c61$export$825e523ef749bd8c
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimRTCDataChannel",
    () => $215e6581d7a09c61$export$ff9cb3bc8990e8f7
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimAddTransceiver",
    () => $215e6581d7a09c61$export$70c77533b6e9908d
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimGetParameters",
    () => $215e6581d7a09c61$export$66238223c298fbaa
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimCreateOffer",
    () => $215e6581d7a09c61$export$51beccf0e777b843
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimCreateAnswer",
    () => $215e6581d7a09c61$export$df0b46e7cef08150
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimGetUserMedia",
    () => $6c9e5f7e9edd1e60$export$1ed4910f4d37dc5e
  );
  $parcel$export(
    $215e6581d7a09c61$exports,
    "shimGetDisplayMedia",
    () => $c12684406b986df8$export$97270b87351d9c04
  );
  /*
   *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
   *
  ...
  function $6c9e5f7e9edd1e60$export$1ed4910f4d37dc5e(window, browserDetails) {
    ...
    navigator.getUserMedia = function (constraints, onSuccess, onError) {
      ...
      $9fea4db837311579$export$cdd73fc4100a6ef4(
   ...
   *  tree.
   */ /* eslint-env node */ ("use strict");
  function $c12684406b986df8$export$97270b87351d9c04(
    window,
  ...
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimLocalStreamsAPI",
    () => $c1f641ee5a6f6c8f$export$8df41282f4fdcea2
  );
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimRemoteStreamsAPI",
    () => $c1f641ee5a6f6c8f$export$762aa4cbb4f2f857
  );
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimCallbacksAPI",
    () => $c1f641ee5a6f6c8f$export$da31df245debdd3
  );
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimGetUserMedia",
    () => $c1f641ee5a6f6c8f$export$1ed4910f4d37dc5e
  );
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimConstraints",
    () => $c1f641ee5a6f6c8f$export$494a01ac68ba81ac
  );
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimRTCIceServerUrls",
    () => $c1f641ee5a6f6c8f$export$671a8b47b41b6f41
  );
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimTrackEventTransceiver",
    () => $c1f641ee5a6f6c8f$export$85d53da088cb1b14
  );
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimCreateOfferLegacy",
    () => $c1f641ee5a6f6c8f$export$d444266503fdd2d4
  );
  $parcel$export(
    $c1f641ee5a6f6c8f$exports,
    "shimAudioContext",
    () => $c1f641ee5a6f6c8f$export$857cd739a7b795d2
  );
  /*
   *  Copyright (c) 2016 The WebRTC project authors. All Rights Reserved.
   *
    ...
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
      ...
      navigator.mediaDevices.getUserMedia = (constraints) => {
        return _getUserMedia(
          $c1f641ee5a6f6c8f$export$494a01ac68ba81ac(constraints)
        );
      };
    }
    if (
  ...
  $parcel$export(
    $5151b78094cea2ba$exports,
    "shimRTCIceCandidate",
    () => $5151b78094cea2ba$export$cf133661e444ccfe
  );
  $parcel$export(
    $5151b78094cea2ba$exports,
    "shimRTCIceCandidateRelayProtocol",
    () => $5151b78094cea2ba$export$fdafb8d8280e29b5
  );
  $parcel$export(
    $5151b78094cea2ba$exports,
    "shimMaxMessageSize",
    () => $5151b78094cea2ba$export$a99147c78a56edc4
  );
  $parcel$export(
    $5151b78094cea2ba$exports,
    "shimSendThrowTypeError",
    () => $5151b78094cea2ba$export$d461c8d5c5db5da7
  );
  $parcel$export(
    $5151b78094cea2ba$exports,
    "shimConnectionState",
    () => $5151b78094cea2ba$export$63bb816cc75460
  );
  $parcel$export(
    $5151b78094cea2ba$exports,
    "removeExtmapAllowMixed",
    () => $5151b78094cea2ba$export$a57d114344295149
  );
  $parcel$export(
    $5151b78094cea2ba$exports,
    "shimAddIceCandidateNullOrEmpty",
    () => $5151b78094cea2ba$export$51d5e40b48c771c7
  );
  $parcel$export(
    $5151b78094cea2ba$exports,
    "shimParameterlessSetLocalDescription",
    () => $5151b78094cea2ba$export$7170d04e59f9d553
  );
  /*
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.localCName =
    $5d0e6002f6ec24ec$var$SDPUtils.generateIdentifier();
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix = function (blob, prefix) {
    return $5d0e6002f6ec24ec$var$SDPUtils
      .splitLines(blob)
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.getMid = function (mediaSection) {
    const mid = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "a=mid:"
    )[0];
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.getDtlsParameters = function (
    mediaSection,
    sessionpart
  ) {
    const lines = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.writeDtlsParameters = function (
    params,
    setupType
  ) {
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.writeCryptoLine = function (parameters) {
    return (
      ...
      (typeof parameters.keyParams === "object"
        ? $5d0e6002f6ec24ec$var$SDPUtils.writeCryptoKeyParams(
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.getCryptoParameters = function (
    mediaSection,
    sessionpart
  ) {
    const lines = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.getIceParameters = function (
    mediaSection,
    sessionpart
  ) {
    const ufrag = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection + sessionpart,
      "a=ice-ufrag:"
    )[0];
    const pwd = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection + sessionpart,
      "a=ice-pwd:"
    )[0];
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.parseRtpParameters = function (mediaSection) {
    ...
    for (let i = 3; i < mline.length; i++) {
      const pt = mline[i];
      const rtpmapline = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
        mediaSection,
        "a=rtpmap:" + pt + " "
      )[0];
      if (rtpmapline) {
        const codec = $5d0e6002f6ec24ec$var$SDPUtils.parseRtpMap(rtpmapline);
        const fmtps = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
          mediaSection,
          "a=fmtp:" + pt + " "
        );
        // Only the first a=fmtp:<pt> is considered.
        codec.parameters = fmtps.length
          ? $5d0e6002f6ec24ec$var$SDPUtils.parseFmtp(fmtps[0])
          : {};
        codec.rtcpFeedback = $5d0e6002f6ec24ec$var$SDPUtils
          .matchPrefix(mediaSection, "a=rtcp-fb:" + pt + " ")
          .map($5d0e6002f6ec24ec$var$SDPUtils.parseRtcpFb);
    ...
    $5d0e6002f6ec24ec$var$SDPUtils
      .matchPrefix(mediaSection, "a=extmap:")
      .forEach((line) => {
        description.headerExtensions.push(
          $5d0e6002f6ec24ec$var$SDPUtils.parseExtmap(line)
        );
      });
    const wildcardRtcpFb = $5d0e6002f6ec24ec$var$SDPUtils
      .matchPrefix(mediaSection, "a=rtcp-fb:* ")
      .map($5d0e6002f6ec24ec$var$SDPUtils.parseRtcpFb);
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.parseRtpEncodingParameters = function (
    mediaSection
  ) {
    const encodingParameters = [];
    const description =
      $5d0e6002f6ec24ec$var$SDPUtils.parseRtpParameters(mediaSection);
    const hasRed = description.fecMechanisms.indexOf("RED") !== -1;
    const hasUlpfec = description.fecMechanisms.indexOf("ULPFEC") !== -1;
    // filter a=ssrc:... cname:, ignore PlanB-msid
    const ssrcs = $5d0e6002f6ec24ec$var$SDPUtils
      .matchPrefix(mediaSection, "a=ssrc:")
      .map((line) => $5d0e6002f6ec24ec$var$SDPUtils.parseSsrcMedia(line))
      .filter((parts) => parts.attribute === "cname");
    const primarySsrc = ssrcs.length > 0 && ssrcs[0].ssrc;
    let secondarySsrc;
    const flows = $5d0e6002f6ec24ec$var$SDPUtils
      .matchPrefix(mediaSection, "a=ssrc-group:FID")
      .map((line) => {
    ...
    let bandwidth = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "b="
    );
    if (bandwidth.length) {
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.parseRtcpParameters = function (mediaSection) {
    ...
    // SSRCs.
    const remoteSsrc = $5d0e6002f6ec24ec$var$SDPUtils
      .matchPrefix(mediaSection, "a=ssrc:")
      .map((line) => $5d0e6002f6ec24ec$var$SDPUtils.parseSsrcMedia(line))
    ...
    const rsize = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "a=rtcp-rsize"
    );
    ...
    const mux = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "a=rtcp-mux"
    );
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.writeRtcpParameters = function (
    rtcpParameters
  ) {
    let sdp = "";
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.parseMsid = function (mediaSection) {
    let parts;
    const spec = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "a=msid:"
    );
    if (spec.length === 1) {
    ...
    const planB = $5d0e6002f6ec24ec$var$SDPUtils
      .matchPrefix(mediaSection, "a=ssrc:")
      .map((line) => $5d0e6002f6ec24ec$var$SDPUtils.parseSsrcMedia(line))
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.parseSctpDescription = function (
    mediaSection
  ) {
    const mline = $5d0e6002f6ec24ec$var$SDPUtils.parseMLine(mediaSection);
    const maxSizeLine = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "a=max-message-size:"
    );
    let maxMessageSize;
    ...
    const sctpPort = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "a=sctp-port:"
    );
    ...
    const sctpMapLines = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "a=sctpmap:"
    );
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.writeSessionBoilerplate = function (
    sessId,
    sessVer,
    sessUser
  ) {
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.getDirection = function (
    mediaSection,
    sessionpart
  ) {
    ...
    if (sessionpart)
      return $5d0e6002f6ec24ec$var$SDPUtils.getDirection(sessionpart);
    return "sendrecv";
  };
  ...
  $5d0e6002f6ec24ec$var$SDPUtils.parseOLine = function (mediaSection) {
    const line = $5d0e6002f6ec24ec$var$SDPUtils.matchPrefix(
      mediaSection,
      "o="
    )[0];
  ...
  function $5151b78094cea2ba$export$a99147c78a56edc4(window, browserDetails) {
    ...
    const sctpInDescription = function (description) {
      ...
      /*@__PURE__*/ $parcel$interopDefault(
        $5d0e6002f6ec24ec$exports
      )).splitSections(description.sdp);
      sections.shift();
      return sections.some((mediaSection) => {
        const mLine = (0,
        /*@__PURE__*/ $parcel$interopDefault(
          $5d0e6002f6ec24ec$exports
        )).parseMLine(mediaSection);
        return (
          mLine &&
    ...
    const getMaxMessageSize = function (description, remoteIsFirefox) {
      ...
      /*@__PURE__*/ $parcel$interopDefault(
        $5d0e6002f6ec24ec$exports
      )).matchPrefix(description.sdp, "a=max-message-size:");
      if (match.length > 0)
  ...
  function $5151b78094cea2ba$export$a57d114344295149(window, browserDetails) {
    /* remove a=extmap-allow-mixed for webrtc.org < M71 */ if (
      !window.RTCPeerConnection
    )
      return;
  ...
  function $b657217e95eb14d8$export$e77bf46c04ac7d12(
    { window: window } = {},
    options = {
      shimChrome: true,
      shimFirefox: true,
    ...
    switch (browserDetails.browser) {
      case "chrome":
        if (
          !$fb04e59b477f17ce$exports ||
          !$fb04e59b477f17ce$exports.shimPeerConnection ||
          !options.shimChrome
        ) {
        ...
        $fb04e59b477f17ce$exports.shimAddTrackRemoveTrack(
          window,
          browserDetails
        );
        $fb04e59b477f17ce$exports.shimGetSendersWithDtmf(
          window,
          browserDetails
        );
        $fb04e59b477f17ce$exports.shimSenderReceiverGetStats(
          window,
          browserDetails
        );
      ...
      case "firefox":
        if (
          !$215e6581d7a09c61$exports ||
          !$215e6581d7a09c61$exports.shimPeerConnection ||
          !options.shimFirefox
        ) {
      ...
      case "safari":
        ...
        $c1f641ee5a6f6c8f$exports.shimTrackEventTransceiver(
          window,
          browserDetails
        );
  ...
  ("use strict");
  const $90c50c10bd6fa8b4$var$adapter = (0,
  $b657217e95eb14d8$export$e77bf46c04ac7d12)({
  ...
  const $a9bc9397a7d36afa$var$webRTCAdapter = //@ts-ignore
    (0, $90c50c10bd6fa8b4$export$2e2bcd8739ae039).default ||
    (0, $90c50c10bd6fa8b4$export$2e2bcd8739ae039);
  const $a9bc9397a7d36afa$export$25be9502477c137d = new (class {
    ...
    isUnifiedPlanSupported() {
      const browser = this.getBrowser();
      const version =
        $a9bc9397a7d36afa$var$webRTCAdapter.browserDetails.version || 0;
  ...
  const $008766fe99f03c2f$export$4e61f672936bec77 = () =>
  ...
  class $01f0d223090cb1f8$export$f8f26dd395d7e1bd extends (0,
  $616ebdf1c4998439$export$f1c5f4c9cb95390b) {
    noop() {}
    ...
    constructor(...args) {
      ...
      this.browser = (0,
      $a9bc9397a7d36afa$export$25be9502477c137d).getBrowser();
      this.browserVersion = (0,
      $a9bc9397a7d36afa$export$25be9502477c137d).getVersion();
       ...
       */ this.supports = (function () {
        const supported = {
          browser: (0,
          $a9bc9397a7d36afa$export$25be9502477c137d).isBrowserSupported(),
          webRTC: (0,
          $a9bc9397a7d36afa$export$25be9502477c137d).isWebRTCSupported(),
          audioVideo: false,
          data: false,
          binaryBlob: false,
          reliable: false,
        ...
        try {
          ...
          try {
            ...
            try {
              dc.binaryType = "blob";
              supported.binaryBlob = !(0,
              $a9bc9397a7d36afa$export$25be9502477c137d).isIOS;
            } catch (e) {}
          } catch (e) {
          } finally {
            if (dc) dc.close();
  ...
  const $01f0d223090cb1f8$export$7debb50ef11d5e0b =
    new $01f0d223090cb1f8$export$f8f26dd395d7e1bd();
  ...
  (function (LogLevel) {
    ...
    $d3fc3aacca52312c$export$243e62d78d3b544d ||
      ($d3fc3aacca52312c$export$243e62d78d3b544d = {})
  );
  class $d3fc3aacca52312c$var$Logger {
    ...
    _print(logLevel, ...rest) {
      const copy = [$d3fc3aacca52312c$var$LOG_PREFIX, ...rest];
      for (const i in copy)
  ...
  var $d3fc3aacca52312c$export$2e2bcd8739ae039 =
    new $d3fc3aacca52312c$var$Logger();

  var $f5d7fbd88de797fd$exports = {};
  ("use strict");
  var $f5d7fbd88de797fd$var$has = Object.prototype.hasOwnProperty,
    $f5d7fbd88de797fd$var$prefix = "~";
  /**
  ...
  if (Object.create) {
    ...
    //
    if (!new $f5d7fbd88de797fd$var$Events().__proto__)
      $f5d7fbd88de797fd$var$prefix = false;
  }
  /**
   ...
   * @private
   */ function $f5d7fbd88de797fd$var$addListener(
    emitter,
    event,
    fn,
    context,
    ...
    var listener = new $f5d7fbd88de797fd$var$EE(fn, context || emitter, once),
      evt = $f5d7fbd88de797fd$var$prefix
        ? $f5d7fbd88de797fd$var$prefix + event
        : event;
   ...
   */ function $f5d7fbd88de797fd$var$clearEvent(emitter, evt) {
    if (--emitter._eventsCount === 0)
      emitter._events = new $f5d7fbd88de797fd$var$Events();
   ...
   * @returns {Array}
   * @public
   */ $f5d7fbd88de797fd$var$EventEmitter.prototype.eventNames =
    function eventNames() {
      var names = [],
        events,
        name;
      ...
      for (name in (events = this._events))
        if ($f5d7fbd88de797fd$var$has.call(events, name))
          names.push($f5d7fbd88de797fd$var$prefix ? name.slice(1) : name);
   ...
   * @public
   */ $f5d7fbd88de797fd$var$EventEmitter.prototype.listeners =
    function listeners(event) {
      var evt = $f5d7fbd88de797fd$var$prefix
          ? $f5d7fbd88de797fd$var$prefix + event
          : event,
   ...
   * @public
   */ $f5d7fbd88de797fd$var$EventEmitter.prototype.listenerCount =
   ...
   * @public
   */ $f5d7fbd88de797fd$var$EventEmitter.prototype.emit = function emit(
    event,
    a1,
    a2,
    a3,
   ...
   * @public
   */ $f5d7fbd88de797fd$var$EventEmitter.prototype.on = function on(
    event,
    fn,
    context
  ) {
   ...
   * @returns {EventEmitter} `this`.
   * @public
   */ $f5d7fbd88de797fd$var$EventEmitter.prototype.once = function once(
    event,
    fn,
    context
  ) {
   ...
   * @returns {EventEmitter} `this`.
   * @public
   */ $f5d7fbd88de797fd$var$EventEmitter.prototype.removeListener =
   ...
   * @returns {EventEmitter} `this`.
   * @public
   */ $f5d7fbd88de797fd$var$EventEmitter.prototype.removeAllListeners =
  ...
  //
  $f5d7fbd88de797fd$var$EventEmitter.prototype.off =
    $f5d7fbd88de797fd$var$EventEmitter.prototype.removeListener;
  $f5d7fbd88de797fd$var$EventEmitter.prototype.addListener =
    $f5d7fbd88de797fd$var$EventEmitter.prototype.on;
  //
  // Expose the prefix.
  //
  ...
  //
  $f5d7fbd88de797fd$var$EventEmitter.EventEmitter =
    $f5d7fbd88de797fd$var$EventEmitter;
  ...
  (function (ConnectionType) {
    ...
    $edbcf3072a01d580$export$3157d57b4135e3bc ||
      ($edbcf3072a01d580$export$3157d57b4135e3bc = {})
  );
  ...
  (function (PeerErrorType) {
    ...
    $edbcf3072a01d580$export$9547aaa2e39030ff ||
      ($edbcf3072a01d580$export$9547aaa2e39030ff = {})
  );
  ...
  (function (BaseConnectionErrorType) {
    ...
    $edbcf3072a01d580$export$7974935686149686 ||
      ($edbcf3072a01d580$export$7974935686149686 = {})
  );
  ...
  (function (DataConnectionErrorType) {
    ...
    $edbcf3072a01d580$export$49ae800c114df41d ||
      ($edbcf3072a01d580$export$49ae800c114df41d = {})
  );
  ...
  (function (SerializationType) {
    ...
    $edbcf3072a01d580$export$89f507cf986a947 ||
      ($edbcf3072a01d580$export$89f507cf986a947 = {})
  );
  ...
  (function (SocketEventType) {
    ...
    $edbcf3072a01d580$export$3b5c4a4b6354f023 ||
      ($edbcf3072a01d580$export$3b5c4a4b6354f023 = {})
  );
  ...
  $f5d7fbd88de797fd$exports.EventEmitter) {
    start(id, token) {
      ...
      this._socket.onmessage = (event) => {
        ...
        try {
          ...
          (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log(
    ...
    /** Exposed send for DC & Peer. */ send(data) {
      ...
      if (!data.type) {
        this.emit(
          (0, $edbcf3072a01d580$export$3b5c4a4b6354f023).Error,
          "Invalid message"
        );
        return;
      }
  ...
  class $3cabb799c2437cbe$export$89e6bb5ad64bf4a {
    /** Returns a PeerConnection object set up correctly (for data, media). */ startConnection(
      options
    ) {
      ...
      if (
        this.connection.type ===
          (0, $edbcf3072a01d580$export$3157d57b4135e3bc).Media &&
        options._stream
      )
        ...
        switch (peerConnection.iceConnectionState) {
          case "failed":
            ...
            this.connection.emitError(
              (0, $edbcf3072a01d580$export$7974935686149686).NegotiationFailed,
          ...
          case "closed":
            ...
            this.connection.emitError(
              (0, $edbcf3072a01d580$export$7974935686149686).ConnectionClosed,
    ...
    async _makeOffer() {
      ...
      try {
        ...
        try {
          ...
          if (
            this.connection.type ===
            (0, $edbcf3072a01d580$export$3157d57b4135e3bc).Data
          ) {
            const dataConnection = this.connection;
            payload = {
              ...payload,
          ...
          if (
            ...
            provider.emitError(
              (0, $edbcf3072a01d580$export$9547aaa2e39030ff).WebRTC,
              err
            );
            (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log(
    ...
    _addTracksToConnection(stream, peerConnection) {
      ...
      if (!peerConnection.addTrack)
        return (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).error(
  ...
  class $41eb28b5735ed6cf$export$6a678e589c8a4542 extends (0,
  $f5d7fbd88de797fd$exports.EventEmitter) {
    /**
     ...
     */ emitError(type, err) {
      ...
      this.emit(
        "error",
        new $41eb28b5735ed6cf$export$98871882f492de82(`${type}`, err)
      );
    }
  }
  ...
  class $f06f075a81a8b63e$export$23a2a68283c24d80 extends (0,
  $41eb28b5735ed6cf$export$6a678e589c8a4542) {
    /**
  ...
  class $0bc12d7ac26e1491$export$4a84e95a2324ac29 extends (0,
  $f06f075a81a8b63e$export$23a2a68283c24d80) {
    /**
    ...
    /** Called by the Negotiator when the DataChannel is ready. */ _initializeDataChannel(
      dc
    ) {
      this.dataChannel = dc;
      this.dataChannel.onopen = () => {
        (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log(
          `DC#${this.connectionId} dc connection success`
        );
        this.emit("willCloseOnRemote");
      };
      this.dataChannel.onclose = () => {
        (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log(
          `DC#${this.connectionId} dc closed for:`,
          this.peer
        );
        this.close();
      };
     ...
     */ handleMessage(message) {
      ...
      switch (message.type) {
        ...
        case (0, $edbcf3072a01d580$export$adb4a1754da6f10d).Candidate:
          ...
          break;
        default:
          (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).warn(
    ...
    constructor(peerId, provider, options) {
      ...
      this.connectionId =
        ...
        $0bc12d7ac26e1491$export$4a84e95a2324ac29.ID_PREFIX +
          (0, $01f0d223090cb1f8$export$7debb50ef11d5e0b).randomToken();
      this._negotiator = new (0, $3cabb799c2437cbe$export$89e6bb5ad64bf4a)(
        this
      );
      if (this._localStream)
        this._negotiator.startConnection({
  ...
  class $4c932c6613316196$export$2c4e825dc9120f87 {
    ...
    /** Get a unique ID from the server via XHR and initialize with it. */ async retrieveId() {
      try {
        ...
        (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).error(
          "Error retrieving ID",
          error
        );
        let pathError = "";
        if (
          this._options.path === "/" &&
          this._options.host !==
            (0, $01f0d223090cb1f8$export$7debb50ef11d5e0b).CLOUD_HOST
        )
          pathError =
  ...
  class $392ccce28b647101$export$d365f7ad9d7df9c9 extends (0,
  $f06f075a81a8b63e$export$23a2a68283c24d80) {
    get type() {
    ...
    /** Called by the Negotiator when the DataChannel is ready. */ _initializeDataChannel(
      ...
      this.dataChannel.onmessage = (e) => {
        (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log(
          `DC#${this.connectionId} dc onmessage:`,
          e.data
        );
    ...
    /** Allows user to send data. */ send(data, chunked = false) {
      if (!this.open) {
        this.emitError(
          (0, $edbcf3072a01d580$export$49ae800c114df41d).NotOpenYet,
    ...
    constructor(peerId, provider, options) {
      ...
      this.connectionId =
        this.options.connectionId ||
        $392ccce28b647101$export$d365f7ad9d7df9c9.ID_PREFIX +
          (0, $008766fe99f03c2f$export$4e61f672936bec77)();
  ...
  class $8d1d5e45d8d6520c$export$ff7c9d4c11d94e8b extends (0,
  $392ccce28b647101$export$d365f7ad9d7df9c9) {
    get bufferSize() {
    ...
    _trySend(msg) {
      ...
      if (
        ...
        (0, $392ccce28b647101$export$d365f7ad9d7df9c9).MAX_BUFFERED_AMOUNT
      ) {
  ...
  class $6b2c8b37149b9a13$export$f0a5a64d5bb37108 extends (0,
  $8d1d5e45d8d6520c$export$ff7c9d4c11d94e8b) {
    close(options) {
      super.close(options);
      this._chunkedData = {};
    }
    ...
    _handleDataMessage({ data: data }) {
      const deserializedData = (0, $bf7fb46c6d68ead7$export$417857010dc9287f)(
        data
      );
    ...
    _handleChunk(data) {
      ...
      if (chunkInfo.total === chunkInfo.count) {
        ...
        const data = (0, $616ebdf1c4998439$export$52c89ebcdc4f53f2)(
          chunkInfo.data
        );
  ...
  class $6faa8477ae391a66$export$6f88fe47d32c9c94 extends (0,
  $8d1d5e45d8d6520c$export$ff7c9d4c11d94e8b) {
    _handleDataMessage({ data: data }) {
  ...
  class $b524315f5ff1ee78$export$48880ac635f47186 extends (0,
  $8d1d5e45d8d6520c$export$ff7c9d4c11d94e8b) {
    // Handles a DataChannel message.
    _handleDataMessage({ data: data }) {
    ...
    _send(data, _chunked) {
      ...
      if (
        ...
        (0, $01f0d223090cb1f8$export$7debb50ef11d5e0b).chunkedMTU
      ) {
        this.emitError(
          (0, $edbcf3072a01d580$export$49ae800c114df41d).MessageToBig,
  ...
  class $11967427976ce06d$export$ecd1fc136c422448 extends (0,
  $41eb28b5735ed6cf$export$6a678e589c8a4542) {
    /**
    ...
    _createServerConnection() {
      const socket = new (0, $5dd3b97502a89fbb$export$4798917dbf149b79)(
      ...
      socket.on(
        (0, $edbcf3072a01d580$export$3b5c4a4b6354f023).Message,
        (data) => {
      ...
      socket.on(
        ...
        (error) => {
          this._abort(
            (0, $edbcf3072a01d580$export$9547aaa2e39030ff).SocketError,
            error
          );
        }
      );
      socket.on(
        (0, $edbcf3072a01d580$export$3b5c4a4b6354f023).Disconnected,
        () => {
          if (this.disconnected) return;
          this.emitError(
            (0, $edbcf3072a01d580$export$9547aaa2e39030ff).Network,
      ...
      socket.on((0, $edbcf3072a01d580$export$3b5c4a4b6354f023).Close, () => {
        if (this.disconnected) return;
        this._abort(
          (0, $edbcf3072a01d580$export$9547aaa2e39030ff).SocketClosed,
    ...
    /** Handles messages from the server. */ _handleMessage(message) {
      ...
      switch (type) {
        ...
        case (0, $edbcf3072a01d580$export$adb4a1754da6f10d).Expire:
          this.emitError(
            (0, $edbcf3072a01d580$export$9547aaa2e39030ff).PeerUnavailable,
        ...
        case (0, $edbcf3072a01d580$export$adb4a1754da6f10d).Offer: {
          ...
          if (
            ...
            const mediaConnection = new (0,
            $0bc12d7ac26e1491$export$4a84e95a2324ac29)(peerId, this, {
              connectionId: connectionId,
              _payload: payload,
            ...
            payload.type === (0, $edbcf3072a01d580$export$3157d57b4135e3bc).Data
          ) {
    ...
    /** Stores messages without a set up connection, to be claimed later. */ _storeMessage(
      connectionId,
      message
    ) {
     ...
     */ connect(peer, options = {}) {
      ...
      if (this.disconnected) {
        ...
        this.emitError(
          (0, $edbcf3072a01d580$export$9547aaa2e39030ff).Disconnected,
     ...
     */ call(peer, stream, options = {}) {
      ...
      const mediaConnection = new (0,
      $0bc12d7ac26e1491$export$4a84e95a2324ac29)(peer, this, {
        ...options,
        _stream: stream,
      });
    ...
    /** Add a data/media connection to this peer. */ _addConnection(
      peerId,
      connection
    ) {
      (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log(
    ...
    /** Retrieve a data/media connection for this peer. */ getConnection(
      peerId,
      connectionId
    ) {
     ...
     */ disconnect() {
      ...
      (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log(
        `Disconnect peer with ID:${currentId}`
      );
      this._disconnected = true;
      this._open = false;
      this.socket.close();
    ...
    constructor(id, options) {
      ...
      if (
        ...
        $01f0d223090cb1f8$export$7debb50ef11d5e0b).isSecure();
      else if (
        this._options.host ==
        (0, $01f0d223090cb1f8$export$7debb50ef11d5e0b).CLOUD_HOST
      )
      ...
      if (this._options.logFunction)
        (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).setLogFunction(
          this._options.logFunction
        );
      (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).logLevel =
      ...
      if (
        !(0, $01f0d223090cb1f8$export$7debb50ef11d5e0b).supports.audioVideo &&
        !(0, $01f0d223090cb1f8$export$7debb50ef11d5e0b).supports.data
      ) {
        this._delayedAbort(
          (0, $edbcf3072a01d580$export$9547aaa2e39030ff).BrowserIncompatible,
      ...
      if (
        !!userId &&
        !(0, $01f0d223090cb1f8$export$7debb50ef11d5e0b).validateId(userId)
      ) {
        this._delayedAbort(
          (0, $edbcf3072a01d580$export$9547aaa2e39030ff).InvalidID,
  ...
  /** @deprecated Should use peerjs namespace */ window.Peer =
    (0, $11967427976ce06d$export$ecd1fc136c422448);
})();
